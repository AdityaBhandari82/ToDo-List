    ...
    <div className="bg-[#DBF2FF] p-6 rounded-lg min-h-screen">
      ...
      <div className="max-w-4xl mx-auto p-4 bg-white rounded-lg border w-full">
        <div className="border-b pb-2 mb-4 flex flex-wrap gap-4 text-blue-500 justify-start">
          ...
          <Link to="/employeemanagement/employeement_info"><button className="hover:underline">Employment Info</button></Link>
          <Link to="/employeemanagement/payroll" className="hover:underline">Payroll</Link>
          <a href="#" className="font-semibold text-gray-900 border-b-2 border-gray-900">Security</a>
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-4 mb-6">
          <div>
            <label className="block text-gray-600 mb-1">Security Role</label>
            <select className="w-full p-2 border border-black rounded-md">
              <option>Select</option>
            </select>
          </div>
          <div>
            <label className="block text-gray-600 mb-1">Leave Entry Days</label>
            <input
              type="text"
              placeholder="100"
        ...
        <div>
          <h2 className="font-semibold text-lg mb-2">Record Level Authority</h2>
          <div className="flex flex-wrap gap-4">
            {[
              ...
              <label key={index} className="flex items-center gap-2">
                <input type="checkbox" className="w-4 h-4" /> {item.label}
              </label>
            ))}
          </div>
        </div>
