...
const SetupPopup = ({ isOpen, onClose }) => {
  ...
  const [formData, setFormData] = useState({
    shift: {
      shiftName: "9 AM to 2 PM",
      shiftIn: { hours: "", minutes: "", seconds: "" },
      shiftOut: { hours: "", minutes: "", seconds: "" },
      shiftOutNextDay: "",
    },
    lateEarlyRelaxation: {
      dailyLateMinute: "",
      ...
      <div className="mt-6 space-y-6 p-4 max-w-4xl mx-auto">
        ...
        <div>
          ...
          >
            ...
            <option value="9 AM to 2 PM">9 AM to 2 PM</option>
            <option value="2 PM to 6 PM">2 PM to 6 PM</option>
          </select>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                type="number"
                value={formData.shift.shiftIn.hours}
                onChange={(e) => handleNestedInputChange("shift", "shiftIn", "hours", e.target.value)}
                placeholder="HH"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
              <input
                type="number"
                value={formData.shift.shiftIn.minutes}
                onChange={(e) => handleNestedInputChange("shift", "shiftIn", "minutes", e.target.value)}
                placeholder="MM"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
              <input
                type="number"
                value={formData.shift.shiftIn.seconds}
                onChange={(e) => handleNestedInputChange("shift", "shiftIn", "seconds", e.target.value)}
                placeholder="SS"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
            </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                type="number"
                value={formData.shift.shiftOut.hours}
                onChange={(e) => handleNestedInputChange("shift", "shiftOut", "hours", e.target.value)}
                placeholder="HH"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
              <input
                type="number"
                value={formData.shift.shiftOut.minutes}
                onChange={(e) => handleNestedInputChange("shift", "shiftOut", "minutes", e.target.value)}
                placeholder="MM"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
              <input
                type="number"
                value={formData.shift.shiftOut.seconds}
                onChange={(e) => handleNestedInputChange("shift", "shiftOut", "seconds", e.target.value)}
                placeholder="SS"
                className="w-full p-2 border border-gray-300 rounded-md"
              />
            </div>
 ...
 "
  ...
  const handleNestedInputChange = (category, field, subField, value) => {
    setFormData((prevData) => ({
      ...prevData,
      [category]: {
        ...prevData[category],
        [field]: {
          ...prevData[category][field],
          [subField]: value
        }
      },
    }));
